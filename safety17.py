...
# Function to highlight the 4x4 grid area around the worker within the grid
def highlight_grid_around_worker(frame, worker_position):
    ...
    for dx in range(0, highlight_size, grid_size):
        for dy in range(0, highlight_size, grid_size):
